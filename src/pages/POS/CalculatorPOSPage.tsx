  ...
  if (step === 'DETAILS') {
    ...
    return (
      <div className="h-[100dvh] max-h-[100dvh] bg-[#f8fafc] text-slate-900 flex flex-col justify-between max-w-md mx-auto p-3 select-none overflow-hidden animate-in fade-in duration-150 font-sans">
        {/* Top Header - Uniform Minimal Standard */}
        <div className="flex items-center justify-between pt-2.5 sm:pt-3 pb-2 px-1 flex-shrink-0">
          <button
            type="button"
            onClick={() => setStep('CALCULATOR')}
            className="h-9 px-3.5 inline-flex items-center gap-1.5 text-xs font-bold text-slate-700 bg-white hover:bg-slate-100 active:scale-95 rounded-xl border border-slate-200/90 shadow-xs transition-all cursor-pointer"
          >
          ...
          <div className="flex items-center space-x-2">
            {isLocationVerified ? (
              <span className="h-9 px-2.5 inline-flex items-center gap-1 text-[11px] font-bold text-emerald-700 bg-emerald-50 border border-emerald-200/80 rounded-xl">
              ...
              <button
                ...
                className="h-9 px-2.5 inline-flex items-center gap-1 text-[11px] font-bold text-amber-700 bg-amber-50 border border-amber-300 rounded-xl hover:bg-amber-100 cursor-pointer"
              >
                <Navigation className={`w-3.5 h-3.5 ${isVerifyingLocation ? 'animate-spin' : ''}`} />
                <span>{isVerifyingLocation ? 'Checking...' : 'GPS'}</span>
              </button>
            )}
            <span className="h-9 px-3 inline-flex items-center text-xs font-bold text-orange-600 bg-orange-50 border border-orange-200 rounded-xl">
              Step 2: Sizing
            </span>
          </div>
        </div>
    ...
    return (
      <div className="h-[100dvh] max-h-[100dvh] bg-[#f8fafc] text-slate-900 flex flex-col justify-between max-w-md mx-auto p-3 select-none overflow-hidden animate-in fade-in duration-150 font-sans">
        ...
        <div className="flex items-center justify-between pt-2.5 sm:pt-3 pb-2 px-1 flex-shrink-0">
          ...
          <span className="h-9 px-3 inline-flex items-center text-xs font-bold text-emerald-700 bg-emerald-50 border border-emerald-200 rounded-xl">
            Step 3: Payment
          </span>
        </div>
